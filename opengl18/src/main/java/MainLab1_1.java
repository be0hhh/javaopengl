...
public class MainLab1_1 implements Runnable, KeyListener {
    private static Thread displayT = new Thread(new MainLab1_1());
    ...
    public void run() {
        Frame frame = new Frame("Lab 1.1 - Darker 10%");
        frame.setLocation(0,0);
        GLCanvas canvas = new GLCanvas();
        int size = frame.getExtendedState();

        canvas.addGLEventListener(new JavaRendererLab1_1());
        frame.add(canvas);
