 ...
 * Каждая грань куба окрашена в оттенки зеленого цвета
 * в зависимости от интенсивности зеленой компоненты
 */
public class MainLab1_4 implements Runnable, KeyListener {
    private static Thread displayT = new Thread(new MainLab1_4());
    ...
    public void run() {
        Frame frame = new Frame("Lab 1.4 - Green Component Histogram");
        frame.setLocation(0, 0);
        GLCanvas canvas = new GLCanvas();
        int size = frame.getExtendedState();

        canvas.addGLEventListener(new JavaRendererLab1_4());
        frame.add(canvas);
