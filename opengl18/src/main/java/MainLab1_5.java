 ...
 * - Правая: комбинация RGB
 * - Левая: инверсия
 */
public class MainLab1_5 implements Runnable, KeyListener {
    private static Thread displayT = new Thread(new MainLab1_5());
    ...
    public void run() {
        Frame frame = new Frame("Lab 1.5 - RGB and Brightness Histogram");
        frame.setLocation(0, 0);
        GLCanvas canvas = new GLCanvas();
        int size = frame.getExtendedState();

        canvas.addGLEventListener(new JavaRendererLab1_5());
        frame.add(canvas);
