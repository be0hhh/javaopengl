 ...
 */
public class MainLab1_3 implements Runnable, KeyListener {
    private static Thread displayT = new Thread(new MainLab1_3());
    ...
    public void run() {
        Frame frame = new Frame("Lab 1.3 - Three Color Shades");
        frame.setLocation(0, 0);
        GLCanvas canvas = new GLCanvas();
        int size = frame.getExtendedState();

        canvas.addGLEventListener(new JavaRendererLab1_3());
        frame.add(canvas);
